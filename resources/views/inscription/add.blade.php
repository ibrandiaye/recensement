                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div>
                                <br>
                                    <button type="submit"  id="btn_enreg" class="btn btn-success btn btn-lg "> ENREGISTRER</button>
           ...
           $("#btn_enreg").prop('disabled', false);
            ...
            $.ajax({
                ...
                success:function(data) {
                    ...
                    if(data[0])
                     {
                        contenu = "<div class='alert alert-danger'> Ctte personne figure déja sur la liste électorale</div>"+
                        "Region : <strong>"+data[0].REGION+"</strong><br>"+
                            "Departement : <strong> "+data[0].DEPARTEMENT+"</strong><br>"+
                            "Commune : <strong>"+data[0].COMMUNE +"</strong><br>";
