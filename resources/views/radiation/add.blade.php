                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nin" id="nin" value="{{ old('nin') }}" class="form-control"  required>
                           ...
                           {{--  <div class="col-md-6">
                            ...
                            <div class="col-lg-12">
                                <label>Motif de la demande de radiation </label>
                                <select class="form-control" name="motif" id="motif" required="">
                                    <option value="">Selectionnez</option>
                                   <option value="Décès (joindre obligatoirement le certificat de décès et la photocopie de la carte d’identité CEDEAO)">Décès (joindre obligatoirement le certificat de décès et la photocopie de la carte d’identité CEDEAO)</option>
                                    <option value="Incapacité juridique  (joindre obligatoirement la décision de justice)">Incapacité juridique (joindre obligatoirement la décision de justice)</option>
                                    <option value="Sur demande de l’intéressé (joindre obligatoirement la photocopie de la carte d’identité CEDEAO)">Sur demande de l’intéressé (joindre obligatoirement la photocopie de la carte d’identité CEDEAO)</option>
                    ...
                    if(data[0])
                     {
                       /* contenu = "Region : <strong>"+data.region+"</strong><br>"+
                           ...
                           "Siege : <strong>"+data.siege+"</strong><br>"+
                            ...
                            $("#nin").val(data[0].ELEC_NUM_ELECTEUR);
